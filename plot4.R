...
plot(data0$DateTime, data0$Global_active_power, type = "n", ylab = "Global Active Power", xlab = "")
lines(data0$DateTime, data0$Global_active_power)


plot(data0$DateTime, data0$Sub_metering_1, type = "n", ylab = "Energy sub metering", xlab = "")
...
plot(data0$DateTime, data0$Voltage, type = "n", ylab = "Voltage", xlab = "datetime")
lines(data0$DateTime, data0$Voltage)

plot(data0$DateTime, data0$Global_reactive_power, type = "n", ylab = "Global_reactive_power", xlab = "datetime")
lines(data0$DateTime, data0$Global_reactive_power)
